![banner](https://github.com/BookkeeperShelter/zerostack-581/blob/main/assets/banner.png?raw=true)
...
```bash
git clone https://github.com/BookkeeperShelter/zerostack-581.git
cd zerostack-581
cargo build --release
cargo run
```
...
<!-- Last updated: 2026-06-06 16:03:40 -->
